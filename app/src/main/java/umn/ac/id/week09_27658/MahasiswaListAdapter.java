package umn.ac.id.week09_27658;
...
public class MahasiswaListAdapter extends
    ...
    @NonNull
    @Override
    public MahasiswaViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
                                                  int viewType) {
    ...
    @Override public void onBindViewHolder(@NonNull MahasiswaViewHolder holder,
                                           int position) {
    ...
    void setDaftarMahasiswa(List<Mahasiswa> mhss){
        daftarMahasiswa = mhss; notifyDataSetChanged();
    }
